                ...
                <div class="col-md-8 offset-md-2">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('updateUserBothBulkImportVehicle', [$vehicleDetailId, $user_bulk_import->id, $user_bulk_import->bulk_import_id]) }}">
                                {{ csrf_field() }}
                                <div class="form-row">
                                    <div class="col">
                                        ...
                                        <select name="car_make" id="car_make" class="form-control {{ $errors->has('car_make') ? 'is-invalid' : '' }}">
                                            ...
                                            @foreach($car_makes as $car_make)
                                                ...
                                                @else
                                                    @if($user_bulk_import->car_make_id == $car_make->id)
                                                        <option value="{{ $user_bulk_import->car_make->slug }}" selected>{{ $user_bulk_import->car_make->name }}</option>
                                                    @else
                                    ...
                                    <div class="col">
                                        ...
                                        <select name="car_model" id="car_model" class="form-control {{ $errors->has('car_model') ? 'is-invalid' : '' }}">
                                            ...
                                            @foreach($car_models as $car_model)
                                                ...
                                                @else
                                                    @if($user_bulk_import->car_model_id == $car_model->id)
                                                        <option value="{{ $user_bulk_import->car_model->slug }}" selected>{{ $user_bulk_import->car_model->name }}</option>
                                                    @else
                                    ...
                                    <div class="col">
                                        ...
                                        <select name="year"  id="year" class="form-control {{ $errors->has('year') ? 'is-invalid' : '' }}" required>
                                            ...
                                            @for($next_year; $next_year >= $start_year; $next_year--)
                                                ...
                                                @else
                                                    @if($user_bulk_import->year == $next_year)
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        ...
                                        <input type="number" name="mileage" id="mileage" class="form-control {{ $errors->has('mileage') ? 'is-invalid' : '' }}" value="{{ old('mileage') != null ? old('mileage') : (int) $user_bulk_import->mileage }}" placeholder="">
                                    ...
                                    <div class="col">
                                        ...
                                        <select name="body_type" id="body_type" class="form-control {{ $errors->has('body_type') ? 'is-invalid' : '' }}">
                                            ...
                                            @foreach($body_types as $body_type)
                                                ...
                                                @else
                                                    @if($user_bulk_import->body_type_id == $body_type->id)
                                                        <option value="{{ $user_bulk_import->body_type->slug }}" selected>{{ $user_bulk_import->body_type->description }}</option>
                                                    @else
                                    ...
                                    <div class="col">
                                        ...
                                        <select name="transmission_type" id="transmission_type" class="form-control {{ $errors->has('transmission_type') ? 'is-invalid' : '' }}">
                                            ...
                                            @foreach($transmission_types as $transmission_type)
                                                ...
                                                @else
                                                    @if($user_bulk_import->transmission_type_id == $transmission_type->id)
                                                        <option  value="{{ $user_bulk_import->transmission_type->slug }}" selected>{{ $user_bulk_import->transmission_type->description }}</option>
                                                    @else
                                    ...
                                    <div class="col">
                                        ...
                                        <select name="car_condition" id="condition" class="form-control {{ $errors->has('car_condition') ? 'is-invalid' : '' }}">
                                            ...
                                            @foreach($car_conditions as $car_condition)
                                                ...
                                                @else
                                                    @if($user_bulk_import->car_condition_id == $car_condition->id)
                                                        <option value="{{ $user_bulk_import->car_condition->slug }}" selected>{{ $user_bulk_import->car_condition->description }}</option>
                                                    @else
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        ...
                                        <select name="duty" id="duty" class="form-control {{ $errors->has('duty') ? 'is-invalid' : '' }}">
                                            ...
                                            @foreach($duties as $duty)
                                                ...
                                                @else
                                                    @if($user_bulk_import->duty_id == $duty->id)
                                                        <option value="{{ $user_bulk_import->duty->slug }}" selected>{{ $user_bulk_import->duty->description }}</option>
                                                    @else
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="number" name="price" id="price" class="form-control {{ $errors->has('price') ? 'is-invalid' : '' }}" value="{{ old('price') != null ? old('price') : (int) $user_bulk_import->price }}" placeholder="">
                                        @if($errors->has('duty'))
                                ...
                                <div class="form-row">
                                    <div class="form-group">
                                        <div class="form-check">
                                            <input class="form-check-input {{ $errors->has('negotiable_price') ? 'is-invalid' : '' }}" name="negotiable_price" type="checkbox" value="allowed" id="negotiable_price" {{ $user_bulk_import->negotiable_price == 'allowed' ? 'checked' : '' }}>
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        ...
                                        <select name="fuel_type" id="fuel_type" class="form-control {{ $errors->has('fuel_type') ? 'is-invalid' : '' }}">
                                            ...
                                            @foreach($fuel_types as $fuel_type)
                                                ...
                                                @else
                                                    @if($user_bulk_import->fuel_type == $fuel_type->slug)
                                                        <option value="{{ $user_bulk_import->fuel_type }}" selected>{{ $user_bulk_import->fuel_type }}</option>
                                                    @else
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="text" id="engine_size" name="engine_size" class="form-control {{ $errors->has('engine_size') ? 'is-invalid' : '' }}" value="{{ old('engine_size') != null ? old('engine_size') : $user_bulk_import->engine_size }}" placeholder="">
                                    ...
                                    <div class="col">
                                        ...
                                        <select name="interior" id="interior" class="form-control {{ $errors->has('interior') ? 'is-invalid' : '' }}">
                                            ...
                                            @foreach($interiors as $interior)
                                                ...
                                                @else
                                                    @if($user_bulk_import->interior == $interior->slug)
                                                        <option value="{{ $user_bulk_import->interior }}" selected>{{ $user_bulk_import->interior }}</option>
                                                    @else
                                    ...
                                    <div class="col">
                                        ...
                                        <select name="colour_type" id="colour_type" class="form-control {{ $errors->has('colour_type') ? 'is-invalid' : '' }}">
                                            ...
                                            @foreach($colour_types as $colour_type)
                                                ...
                                                @else
                                                    @if($user_bulk_import->colour_type_id == $colour_type->id)
                                                        <option value="{{ $user_bulk_import->colour_type->slug }}" selected>
                                                            {{ $user_bulk_import->colour_type->description }}
                                                        </option>
                                                    @else
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        ...
                                        <textarea class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" id="description" name="description" rows="3">{{ old('description') != null ? old('description') : $user_bulk_import->description  }}</textarea>
