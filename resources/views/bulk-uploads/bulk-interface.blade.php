                              ...
                              Finish
                                ...
                                <div class="page-header card">
                                    <div class="card-block">
                                        <h5>
                                            Batch No : {{$bulk_import->unique_identifier}}
                                        </h5>
                                        <a href="{{ route('showBulkPaymentsPage', $bulk_import->id) }}" class="btn btn-primary pull-right">
                                            Proceed To Pay
                                        </a>
                                ...
                                <a href="{{ route('showBulkPaymentsPage', $bulk_import->id) }}" class="btn btn-lg btn-success float-left">Proceed To Pay</a>

                                <a href="{{ route('showBulkPaymentsPage', $bulk_import->id) }}" class="btn btn-lg btn-success float-right">Proceed To Pay</a>
                            </div>
                        </div>
                    </div>
                </div>
